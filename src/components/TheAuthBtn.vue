...
export default {
  ...
  data() {
    return {
      ...
      state: '',
      scope: 'user-read-recently-played playlist-read-private user-library-read user-library-modify user-follow-read playlist-modify-public playlist-modify-private user-follow-modify',
      show_dialog: false,
    };
  },
  computed: {
  ...
  methods: {
    connectWithSpotify() {
      ...
      window.location = this.getAuthUri;
    },
